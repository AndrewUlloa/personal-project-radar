        ...
        >
          {report.map((item, index) => (
            <motion.a
              ...
              className="flex-shrink-0 w-[300px] bg-pb-surface border rounded-lg hover:shadow-md transition-all duration-200 group"
              ...
              <div className="p-6 flex flex-col h-full">
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-2">
                    <div className="p-2 bg-pb-primary/10 rounded-lg group-hover:bg-pb-primary/20 transition-colors">
                      <FileText className="w-5 h-5 text-pb-primary" />
                    </div>
                    <span className="text-sm font-normal text-pb-muted">
                      SEC Filing
                    </span>
                  </div>
                  <ArrowUpRight className="w-4 h-4 text-pb-muted group-hover:text-pb-primary transition-colors" />
                </div>
